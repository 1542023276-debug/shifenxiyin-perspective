...
2. 配置 API Key（二选一）：
   ...
   - **Key 从哪来**：需**自行向服务方申请**。随包的 `macro_api.md` 是接口文档，其中出现的 apikey 仅为占位示例、不可直接使用；取得自己的 Key 后按上面任一方式配置即可
3. 使用示例：
   ```bash
